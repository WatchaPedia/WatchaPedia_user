...
public class Star {
    ...
    @JoinColumn(name = "star_user_idx")
    private User starUserIdx;
    private Long starPoint;

    protected Star(){}

    public Star(String starContentType, Long starContentIdx, User starUserIdx, Long starPoint) {
...
//    }
    ...
    public static Star of(String starContentType, Long starContentIdx, User starUserIdx, Long starPoint){
