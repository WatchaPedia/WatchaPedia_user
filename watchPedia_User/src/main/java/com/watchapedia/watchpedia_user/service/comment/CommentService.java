...
public class CommentService {
    ...
    public CommentResponse findComment(Long commentIdx, Long userIdx, Pageable pageable){
        ...
        return CommentResponse.from(
                ...
                recommentRepository.findByRecommCommIdxOrderByRecommIdxDesc(comment.getCommIdx(),pageable).stream().map(RecommentDto::from).map(
                        dto -> {
    ...
    public Page<CommentResponse> commentList(String contentType, Long contentIdx, Long userIdx, Pageable pageable){
        ...
        commentResponseList = commentRepository.findByCommContentTypeAndCommContentIdx(
            ...
            return CommentResponse.from(dto,
                    ...
                    recommentRepository.findByRecommCommIdx(dto.idx()).size(),
